  ...
  return (
    <div className="StatSummary">
      <div className='StatSummaryColumn'>
        ...
        <p className='StatSummaryValue'>{mean ? mean.toFixed(1) : <Skeleton />}</p>
      </div>
      <div className='StatSummaryColumn'>
        <p className='StatSummaryLabel'>{median ? 'Median' : <Skeleton />}</p>
        <p className='StatSummaryValue'>{median ? median.toFixed(1) : <Skeleton />}</p>
      </div>
      <div className='StatSummaryColumn'>
        <p className='StatSummaryLabel'>{stdev ? 'StDev' : <Skeleton />}</p>
        <p className='StatSummaryValue'>{stdev ? stdev.toFixed(1) : <Skeleton />}</p>
      </div>
    </div>
  );
}
